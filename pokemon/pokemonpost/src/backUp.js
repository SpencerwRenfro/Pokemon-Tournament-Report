    ...
    <div className=" grid grid-cols-1 m-32">
      <div className=" card-body  mx-10 col-span-1">
        ...
        <div className="col-span-1">
          ...
          <h1 id={aboutMeHref} className="text-3xl font-bold">About Me</h1>
          <div >
          ...
          <h1 id={seasonSummary} className="text-3xl font-bold">2022–2023 Season Summary</h1>
        ...
        <li className="col-span-4"><Link className="btn-ghost" target="_blank" rel="noopener noreferrer" to="/bonus">Projects Page</Link></li>
